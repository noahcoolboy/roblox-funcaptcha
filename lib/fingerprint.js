const baseFingerprint = {
    ...
    "PK": "Win32", // Platform
    "CFP": false, // Canvas fingerprint (if canvas is supported)
...
function getFingerprint() {
    ...
    fingerprint["S"] = [Math.floor(Math.random() * 1920), Math.floor(Math.random() * 1200)]
    fingerprint["AS"] = [Math.floor(Math.random() * 1920), Math.floor(Math.random() * 1200)]
    fingerprint["TO"] = Math.floor(Math.random() * 1440)
