class Session {
    ...
    constructor(captchaInfo, originalToken) {
        ...
        // Suppressed captchas mean they can be skipped entirely
        // To keep backwards compatibility, I won't set the waves to 0
        this.suppressed = this.originalToken.includes("sup=1")
    }
